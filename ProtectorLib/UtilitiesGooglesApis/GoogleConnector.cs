...
namespace UtilitiesGooglesApis
{
    public class GoogleConnector
    {
        ...
        public static GeocodeEntity MakeRequest(string addressNumber, string streetName, string cityName, string countryName)
        {
            ...
            try
            {
                ...
                using (HttpWebResponse response = request.GetResponse() as HttpWebResponse)
                {
                    ...
                    DataContractJsonSerializer jsonSerializer = new DataContractJsonSerializer(typeof(GeocodeEntity));
                    object objResponse = jsonSerializer.ReadObject(response.GetResponseStream());
                    GeocodeEntity jsonResponse = objResponse as GeocodeEntity;
                    return jsonResponse;
                }
            }
            catch (Exception e)
